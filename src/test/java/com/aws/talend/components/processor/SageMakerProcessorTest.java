...
public class SageMakerProcessorTest {

    @ClassRule
    public static final SimpleComponentRule COMPONENT_FACTORY = new SimpleComponentRule("com.aws.talend.components");
    ...
    public void map() throws IOException {
        ...
        final SageMakerProcessorConfiguration configuration =  new SageMakerProcessorConfiguration();

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(SageMakerProcessor.class, configuration);
